...
require (
	...
	k8s.io/apimachinery v0.21.14 // indirect
	k8s.io/apiserver v0.21.14 // indirect
	k8s.io/client-go v0.21.14 // indirect
	k8s.io/component-base v0.21.14 // indirect
	k8s.io/klog/v2 v2.9.0 // indirect
	k8s.io/kubernetes v1.21.14 // indirect
...
replace (
	...
	k8s.io/cri-api => k8s.io/cri-api v0.21.15-rc.0
	...
	k8s.io/mount-utils => k8s.io/mount-utils v0.21.15-rc.0
